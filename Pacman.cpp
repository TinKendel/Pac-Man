...
//int Pacman::scoreValue(int& score, std::array<std::array<Cell, MAP_HEIGHT>, MAP_WIDTH>& i_map)
//{
//	short i_x = position.x;
//	short i_y = position.y;
//
...
//int Pacman::finalScore(int& score, std::array<std::array<Cell, MAP_HEIGHT>, MAP_WIDTH>& i_map)
//{
//	if (1 == scoreValue(PACMAN_SPEED + position.x, position.y, i_map))
//	{
//		score += 10;
//	}
//	if (1 == scoreValue(position.x, position.y - PACMAN_SPEED, i_map))
//	{
//		score += 10;
//	}
//	if (1 == scoreValue(position.x - PACMAN_SPEED, position.y, i_map))
//	{
//		score += 10;
//	}
//	if (1 == scoreValue(position.x, PACMAN_SPEED + position.y, i_map))
