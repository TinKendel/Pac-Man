...
std::array<std::array<Cell, MAP_HEIGHT>, MAP_WIDTH> convert_outline_sketch(const std::array<std::string, MAP_HEIGHT>& i_map_sketch)
{
	std::array<std::array<Cell, MAP_HEIGHT>, MAP_WIDTH> output_map_2;
