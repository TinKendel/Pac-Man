...
public:
	...
	void reset(const Position& i_home, const Position& i_home_exit, SoundManager& gameSounds);
	void set_position(short i_x, short i_y);
	void switch_mode(); 
	void update(unsigned char i_level, std::array<std::array<Cell, MAP_HEIGHT>, MAP_WIDTH>& i_map, Ghost& i_ghost_0, Pacman& i_pacman, SoundManager& gameSounds, int difficulty);
